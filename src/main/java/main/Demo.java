...
public class Demo {
    ...
    public List<List<GeoPosition>> runSearches(MapNode startNode, MapNode endNode, List<Planner> planners) {
        ...
        for (Planner planner : planners) {
            ...
            //System.out.printf("Elapsed Time: %d", total_time);
            //print out
            System.out.printf("\nResult of Planner: %s:%n", planner.getName());
            printResult(result);
    ...
    public static void main(String[] args) {
        ...
        Planner ucsPlanner = new UniformCostPlanner(cost);
        Planner greedyBFPlanner = new GreedyBestFirstPlanner(heuristic);
        Planner aStarPlanner = new AStarPlanner(heuristic, cost);
        
        List<Planner> planners = new ArrayList<>();
        planners.add(bfsPlanner);
        planners.add(dfsPlanner);
        planners.add(ucsPlanner);
        planners.add(greedyBFPlanner);
